 ...
 * phần đại diện cho game bao gồm màu sắc và quân cờ
 * 
*/public class Piece {
	// màu sắc quân cờ
	private int color;
	...
	// bàn cờ vua được chơi trên 1 bảng vuông
	// với tám hàng được dánh dấu từ 1 - 8
	// và tám cột được gán chữ cái từ a - h
	private int row;
	...
	// kiểm tra có quân cờ nào bị bắt hay k
